...
@export var slow_down_speed : int = 1800
...
enum  State { Idle, Run, Jump, Jumpstuck,Shoot }
...
func player_animations():
	...
	elif current_state == State.Jumpstuck:
		animated_sprite_2d.play("jumpstuck")
